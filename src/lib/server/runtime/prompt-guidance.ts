export const MURPH_PROMPT_GUIDANCE = [
  ...
  'When a thread depends on an offline user, preserve continuity without pretending to be that user.',
  ...
  'Defer or abstain when the thread requires certainty that is not present in current context or retrieved evidence.',
  'Do not make policy exceptions, irreversible decisions, or commitments on the user\'s behalf.',
  '',
