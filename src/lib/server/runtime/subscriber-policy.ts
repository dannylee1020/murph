...
function mergeHostSafetyFloor(subscriber: CompiledPolicy, host: CompiledPolicy, executionMode: PolicyExecutionMode): CompiledPolicy {
  return normalizeCompiledPolicy({
    ...
    blockedActions: [...host.blockedActions, ...subscriber.blockedActions],
    executionMode,
    requireGroundingForFacts: host.requireGroundingForFacts || subscriber.requireGroundingForFacts,
