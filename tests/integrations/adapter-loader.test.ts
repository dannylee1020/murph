...
describe('integration adapter loader', () => {
  ...
  it('loads a direct adapter file', async () => {
    ...
    const { loadIntegrationAdapters } = await import('#app/server/integrations/adapter-loader');
    const { listAdapters } = await import('#app/server/integrations/adapter-registry');
  ...
  it('records duplicate adapter IDs without overriding the first adapter', async () => {
    ...
    const { loadIntegrationAdapters } = await import('#app/server/integrations/adapter-loader');
    const { listAdapters, listAdapterStatuses } = await import('#app/server/integrations/adapter-registry');
