...
import { searchLocalFiles, toArtifact as localFsToArtifact } from '#shared/server/context-sources/local-fs';
import { createFileReadTool } from '#shared/server/tools/file-ops';
import { createShellExecTool } from '#shared/server/tools/shell';
import { createWebFetchTool } from '#shared/server/tools/web-fetch';
import { createWebSearchTool } from '#shared/server/tools/web-search';
import { registerBuiltInChannelPlugins } from '#shared/server/channels/register-builtins';
import { getSlackService } from '#shared/server/channels/slack/service';
import { getDiscordArchiveService, readDiscordThread, toArtifact as discordToArtifact } from '#shared/server/context-sources/discord-archive';
import { getStore } from '#shared/server/persistence/store';
import { getToolRegistry } from '#shared/server/capabilities/tool-registry';
import type { ChannelMessage, ContextArtifact, ToolDefinition } from '#shared/types';
