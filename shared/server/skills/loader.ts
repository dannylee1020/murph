...
import { SKILLS_ROOT } from '#shared/config';
import { listRegisteredPluginSkills } from '#shared/server/capabilities/plugins';
import { listScopedPluginSkills } from '#shared/server/plugins/skill-registry';
import { userSkillRoot } from '#shared/server/setup/paths';
