import { getDiscordService, type DiscordSearchResult } from '#shared/server/channels/discord/service';
import type { ContextArtifact, ChannelThreadRef } from '#shared/types';
