...
This guide has moved to [Channels: Discord](/docs/channels/discord).
...
For setup details, see [Channels: Discord](/docs/channels/discord), [Watched Channels](/docs/channels/watched-channels), and [Configuration](/docs/configuration).
