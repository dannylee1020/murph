...
For a runtime that should keep running for a remote team, deploy Murph on a VPS or managed container service. See [Hosting](/docs/hosting) for Docker, public URL, reverse proxy, tunnel, and managed-service options.
...
- [Hosting](/docs/hosting): deploy Murph on a VPS, managed container service, or stable tunnel.
