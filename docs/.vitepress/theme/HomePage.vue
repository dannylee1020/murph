    ...
    <div class="murph-frame">
      ...
      <section class="murph-hero" aria-labelledby="hero-heading">
        <div class="murph-hero-inner">
          <h1 id="hero-heading">Self-hosted runtime for async work.</h1>
          <p class="murph-lede">
            Run one host you control, connect personal DMs and shared channels,
            and let Murph draft, send, queue, or skip work using your context
            and policy.
          </p>
