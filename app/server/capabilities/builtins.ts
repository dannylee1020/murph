...
import { searchLocalFiles, toArtifact as localFsToArtifact } from '#app/server/context-sources/local-fs';
import { createFileReadTool } from '#app/server/tools/file-ops';
import { createShellExecTool } from '#app/server/tools/shell';
import { createWebFetchTool } from '#app/server/tools/web-fetch';
import { createWebSearchTool } from '#app/server/tools/web-search';
import { registerBuiltInChannelPlugins } from '#app/server/channels/register-builtins';
import { getSlackService } from '#app/server/channels/slack/service';
import { getDiscordArchiveService, readDiscordThread, toArtifact as discordToArtifact } from '#app/server/context-sources/discord-archive';
import { getStore } from '#app/server/persistence/store';
import { getToolRegistry } from '#app/server/capabilities/tool-registry';
import type { ChannelMessage, ContextArtifact, ToolDefinition } from '#app/types';
