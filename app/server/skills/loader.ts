...
import { SKILLS_ROOT } from '#app/config';
import { listRegisteredPluginSkills } from '#app/server/capabilities/plugins';
import { listScopedPluginSkills } from '#app/server/plugins/skill-registry';
import { userSkillRoot } from '#app/server/setup/paths';
import type { SkillManifest } from '#app/types';
