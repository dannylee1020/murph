import { getGmailService, toArtifact as gmailToArtifact } from '#app/server/context-sources/gmail';
import { getGoogleCalendarService, toArtifact as calendarToArtifact } from '#app/server/context-sources/google-calendar';
...
import { compactCalendarEvents, queryFromThread, workdayWindowForDate } from '../common.js';
