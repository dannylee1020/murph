import { getGitHubService, toArtifact as githubToArtifact } from '#app/server/context-sources/github';
import { buildRetrievalQuery } from '#app/server/util/retrieval-query';
import type { IntegrationAdapter } from '../adapter.js';
import { queryFromThread } from '../common.js';
